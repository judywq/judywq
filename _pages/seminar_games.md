...
description: Games we play in the seminar
nav: false
...
_styles: |
  ...
  .post article hr {
    ...
    width: 100%;
    margin: 3.25rem 0;
    background: linear-gradient(90deg, transparent 0%, rgba(227, 92, 15, 0.6) 18%, #16418f 50%, rgba(227, 92, 15, 0.6) 82%, transparent 100%);
    opacity: 0.9;
  }
  .post article hr::after {
    content: "\2766";
    display: block;
    position: relative;
    top: -0.85em;
...
Store header images are sourced from the games’ Steam store pages and are used here for identification and commentary purposes only.
...
<div class="row mt-3">
    <div class="col-md-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/games/to-the-moon.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-md-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/games/death-and-taxes.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-md-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/games/the-rootrees-are-dead.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-md-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/games/two-point-campus.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-md-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/games/what-remains-of-edith-finch.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-md-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/games/life-is-strange.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-md-8 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/games/heavy-rain.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
